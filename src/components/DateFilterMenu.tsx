  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button className={cn("flex items-center w-full sm:w-auto min-w-0 sm:min-w-[85px] sm:max-w-[135px] xl:max-w-[165px] h-10 sm:h-11 bg-white border border-[#efefef] rounded-full text-xs sm:text-sm px-2.5 sm:px-3 focus:outline-none focus:ring-2 focus:ring-[#0068f9] shadow-2xs hover:bg-[#faf9f7] transition-all cursor-pointer", className)}>
          <Clock className="text-[#a5a5a5] mr-1.5 sm:mr-2 shrink-0" size={15} />
