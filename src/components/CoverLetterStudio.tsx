...
export function CoverLetterStudio({ initialText, companyName, targetRole, onClose, embedded = false }: CoverLetterStudioProps) {
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
    // Prevent any ancestor or document listeners from intercepting key events
    e.stopPropagation();
