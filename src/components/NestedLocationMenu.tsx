  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button className={cn("flex items-center w-full sm:w-auto min-w-0 sm:min-w-[120px] sm:max-w-[180px] xl:max-w-[210px] h-[38px] bg-white border border-[#efefef] rounded-full text-sm font-medium px-4 focus:outline-none focus:ring-2 focus:ring-[#0068f9] shadow-2xs hover:bg-[#faf9f7] transition-all cursor-pointer", className)}>
          <MapPin className="text-[#a5a5a5] mr-2 shrink-0" size={15} />
